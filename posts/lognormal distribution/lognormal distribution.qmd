...
Suppose the lifetime of an engine has a lognormal distribution. What is the probability that the lifetime will exceed 12,000 hours if the mean is 11,000 hours and the standard deviation is 1.3 hours?
...
# Add legend
legend("bottomright", legend = c("CDF", "Threshold"), col = c("blue", "red"), border = NA, lty = 1:2, cex = 0.8, bty = "n")
