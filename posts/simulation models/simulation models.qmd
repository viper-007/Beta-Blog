...
The statement *"All models are wrong, but some are useful"* is usually attributed to the statistician George Box \[1\]. A model is an approximation of reality. Reality is more complex than any model.
